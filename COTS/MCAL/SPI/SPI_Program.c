...
/*============================================================================================================*/
/*=============================       A.Talaat SPI Functions Implementation        ============================*/
/*============================================================================================================*/
...
/*        Master I/O PIN Mode           */
/*--------------------------------------*/
	DIO_Set_Pin_directio(portB,pin5,Output);         // MOSI OUTPUT in Master Mode
    DIO_Set_Pin_directio(portB,pin6,Input);          // MISO INPUT  in Master Mode
    DIO_Set_Pin_directio(portB,pin7,Output);         // CLOK OUTPUT in Master Mode
    DIO_Set_Pin_directio(portB,pin4,Input);          // SS Slave Select INPUT in Master Mode if we have one Slave only
    DIO_Connectpullup(portB,pin4,High);          // For Protection From Noise and Set 0 at SS in Slave to Activate this one Slave
/*======================================*/
/*          Select Master  Mode         */
/*--------------------------------------*/
...
/*          Slave I/O PIN Mode          */
/*--------------------------------------*/
	DIO_Set_Pin_directio (portB,pin5,Input);         // MOSI  INPUT in Slave Mode
	DIO_Set_Pin_directio (portB,pin6,Output);         // MISO OUTPUT in Slave Mode
	DIO_Set_Pin_directio (portB,pin7,Input);         // CLOK  INPUT in Slave Mode
	DIO_Set_Pin_directio (portB,pin4,Input);         // SS Slave Select INPUT in Slave Mode
    DIO_Set_Pin_value (portB,pin4,Low);               // Set LOW on SS Always if we have one Slave
/*======================================*/
/*          Select Slave  Mode          */
/*--------------------------------------*/
